  ...
  return (
    <div className="min-h-[calc(100vh-theme(spacing.16))] flex flex-col items-center justify-between">
      <div className="flex-1 w-full max-w-[480px] px-4 flex flex-col justify-center py-12">
        <h1
          className="font-semibold text-[32px] leading-[44.3px] tracking-normal text-center align-middle mb-8 text-primary"
        >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col w-full gap-[24px]">
          <div className="flex flex-col">
            ...
            <input
              ...
              className={`w-full h-[40px] border rounded-[6px] px-3 focus:outline-none focus:ring-2 focus:ring-primary/20 ${errors.email ? 'border-red-500' : 'border-gray-300'
                }`}
            />
            <div className="h-5">
          ...
          <div className="flex flex-col relative">
            ...
            <input
              ...
              className={`w-full h-[40px] border rounded-[6px] px-3 pr-10 focus:outline-none focus:ring-2 focus:ring-primary/20 ${errors.password ? 'border-red-500' : 'border-gray-300'
                }`}
            />
            <button
              type="button"
          ...
          <div className="text-right -mt-2">
            <Link to="/forgot-password" className="text-sm text-gray-600 underline hover:text-primary transition-colors">
              Forgot password?
            </Link>
          </div>
